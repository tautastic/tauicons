...
const Geist: Icon = forwardRef<SVGSVGElement, IconProps>(({ ...props }, ref) => {
  ...
  return (
    <svg ref={ref} width={iconProps.size} height={iconProps.size} {...iconProps}>
      <path
        ...
        strokeWidth="0"
      ></path>
      <circle cx="12" cy="4" r="2" stroke="currentColor" strokeWidth="1.5"></circle>
      <circle cx="3" cy="20" r="2" stroke="currentColor" strokeWidth="1.5"></circle>
      <circle cx="21" cy="20" r="2" stroke="currentColor" strokeWidth="1.5"></circle>
    </svg>
  );
});

Geist.displayName = "Geist";
